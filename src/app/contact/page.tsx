            ...
            {state?.success ? (
              ...
              <form action={formAction} className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <Input id="subject" name="subject" placeholder="Data analysis inquiry" required disabled={isPending} />
                </div>

                <div className="space-y-2">
                  <Label htmlFor="message">How can we help?</Label>
                  <Textarea id="message" name="message" placeholder="Describe your project or spatial data needs..." rows={5} required disabled={isPending} />
                </div>
                ...
                <Button type="submit" size="lg" className="w-full bg-primary hover:bg-primary/90 gap-2" disabled={isPending}>
