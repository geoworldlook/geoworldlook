...
// In a real implementation, these would be fetched from the filesystem using gray-matter
const blogPosts = [
  {
  ...
  {
    slug: 'maplibre-expressions-styling',
    title: 'Modern Map Styling with MapLibre GL JS',
    excerpt: 'Learn how to create dynamic, data-driven visualizations using complex expressions and vector tile properties directly in the browser.',
  ...
  return (
    <div className="container mx-auto px-4 py-24 space-y-16">
      <div className="text-center space-y-4 max-w-3xl mx-auto">
        ...
        <h1 className="text-4xl md:text-6xl font-headline font-bold">Geospatial Engineering Blog</h1>
      ...
      <div className="space-y-8 max-w-5xl mx-auto">
        {blogPosts.map((post) => (
          <Link key={post.slug} href={`/blog/${post.slug}`} className="block">
            <Card className="group border-white/[0.06] bg-[#111111]/50 hover:bg-[#111111] hover:border-emerald-400/30 transition-all overflow-hidden p-0">
