...
import { Globe, Map, Code, Database, Satellite } from 'lucide-react'
    ...
    <div className="container mx-auto px-4 py-24 space-y-24">
      <section className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        <div className="space-y-8">
          <h1 className="text-4xl md:text-6xl font-headline font-bold">Unlocking the Power of <span className="text-primary">Spatial Intelligence</span></h1>
          ...
          <div className="space-y-4">
            <h3 className="text-xl font-bold border-l-4 border-primary pl-4">Our Mission</h3>
      ...
      <section className="bg-card p-12 rounded-3xl border border-border">
        ...
        <div className="flex flex-col md:flex-row gap-12 items-center">
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-4">
              <span className="text-xs font-mono uppercase tracking-widest text-primary font-bold">GISP Certified</span>
              <span className="text-xs font-mono uppercase tracking-widest text-primary font-bold">PhD Geo Informatics</span>
            </div>
          </div>
        </div>
      </section>
