...
const MOCK_STATS: VineyardStat[] = [
  { block_id: 'block-1', date: '2024-01-01', cloud_cover: 10, ndvi_mean: 0.45, ndmi_mean: 0.15 },
  { block_id: 'block-1', date: '2024-02-01', cloud_cover: 5, ndvi_mean: 0.48, ndmi_mean: 0.18 },
  { block_id: 'block-1', date: '2024-03-01', cloud_cover: 20, ndvi_mean: 0.55, ndmi_mean: 0.25 }
];

/**
 * Custom hook for managing vineyard polygon data from Supabase.
 */
