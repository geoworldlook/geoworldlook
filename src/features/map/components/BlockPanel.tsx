      ...
      <CardContent className="space-y-4">
        ...
        <div className="flex gap-2 mb-2">
          <Button
            variant="outline"
            size="sm"
            className={`text-[10px] h-7 ${showNDVI ? 'bg-emerald-500/20 border-emerald-500 text-emerald-400' : 'bg-transparent text-gray-500'}`}
          ...
          <Button
            variant="outline"
            size="sm"
            className={`text-[10px] h-7 ${showNDMI ? 'bg-blue-500/20 border-blue-500 text-blue-400' : 'bg-transparent text-gray-500'}`}
