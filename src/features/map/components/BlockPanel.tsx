        ...
        {latestData ? (
          <>
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="bg-white/[0.03] p-3 rounded-lg border border-white/[0.05]">
                <p className="text-[10px] text-gray-500 uppercase mb-1 flex items-center gap-1">
                  <Droplets className="w-3 h-3" /> Current NDMI
                </p>
            ...
            <div className="space-y-4">
              <div className="h-32 w-full">
                <p className="text-[10px] text-gray-500 uppercase mb-2">Vegetation Index (NDVI)</p>
              ...
              <div className="h-32 w-full">
                <p className="text-[10px] text-gray-500 uppercase mb-2">Water Stress (NDMI)</p>
                <ResponsiveContainer width="100%" height="100%">
                  <LineChart data={chartData}>
                    <CartesianGrid strokeDasharray="3 3" stroke="#ffffff10" vertical={false} />
                    <XAxis
