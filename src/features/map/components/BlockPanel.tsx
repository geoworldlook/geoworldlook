      ...
      <CardContent className="space-y-4">
        ...
        <div className="flex gap-2">
          <Button
            variant="outline"
            size="sm"
            className={`text-[10px] h-7 ${activeTab === 'ndvi' ? 'bg-emerald-500/20 border-emerald-500/50 text-emerald-400' : 'text-gray-400'}`}
          ...
          <Button
            variant="outline"
            size="sm"
            className={`text-[10px] h-7 ${activeTab === 'ndmi' ? 'bg-sky-500/20 border-sky-500/50 text-sky-400' : 'text-gray-400'}`}
          ...
          <Button
            variant="outline"
            size="sm"
            className={`text-[10px] h-7 ${activeTab === 'both' ? 'bg-white/10 border-white/20 text-white' : 'text-gray-400'}`}
        ...
        <div className="flex items-center justify-between text-[10px] text-gray-500 italic">
          <div className="flex items-center gap-1">
            <Cloud className="w-3 h-3" /> Cloud cover avg: {latestData ? latestData.cloud_cover.toFixed(1) : '0'}%
          </div>
