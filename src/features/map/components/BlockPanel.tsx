      ...
      <CardContent className="space-y-4">
        ...
        <div className="flex gap-2 mb-2">
          <Button
            variant="outline"
            size="sm"
            className={`text-[10px] h-7 ${activeMetric === 'ndvi' ? 'bg-emerald-500/20 border-emerald-500/50' : 'bg-transparent'}`}
          ...
          <Button
            variant="outline"
            size="sm"
            className={`text-[10px] h-7 ${activeMetric === 'ndmi' ? 'bg-blue-500/20 border-blue-500/50' : 'bg-transparent'}`}
          ...
          <Button
            variant="outline"
            size="sm"
            className={`text-[10px] h-7 ${activeMetric === 'both' ? 'bg-white/10 border-white/20' : 'bg-transparent'}`}
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2 text-[10px] text-gray-500 italic">
            ...
            Last updated: {latestData ? latestData.date : 'N/A'}
          </div>
          <div className="flex items-center gap-1 text-[10px] text-sky-400">
             <Cloud className="w-3 h-3" /> {latestData ? latestData.cloud_cover : 0}% cloud
          </div>
        </div>
      </CardContent>
    </Card>
