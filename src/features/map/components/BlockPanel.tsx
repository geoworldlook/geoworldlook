      ...
      <CardContent className="space-y-4">
        ...
        <div className="flex gap-2 mb-2">
          <Button
            variant="outline"
            size="sm"
            className={`text-[10px] h-7 ${activeMetric === 'both' ? 'bg-emerald-500/20 border-emerald-500/50' : 'bg-transparent'}`}
          ...
          <Button
            variant="outline"
            size="sm"
            className={`text-[10px] h-7 ${activeMetric === 'ndmi' ? 'bg-sky-500/20 border-sky-500/50' : 'bg-transparent'}`}
        ...
        {latestData && (
          <div className="flex items-center justify-between text-[10px] text-gray-500 italic">
            ...
            <div className="flex items-center gap-1">
              <Calendar className="w-3 h-3" /> Last: {latestData.date}
            </div>
          </div>
        )}
      </CardContent>
