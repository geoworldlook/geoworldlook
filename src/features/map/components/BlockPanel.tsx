    ...
    <Card className="absolute top-4 right-4 w-80 md:w-96 shadow-2xl border-white/[0.1] bg-black/90 backdrop-blur-md animate-in slide-in-from-right duration-300 z-[1000]">
      ...
      <CardContent className="space-y-4">
        <div className="grid grid-cols-2 gap-4">
          <div className={`p-3 rounded-lg border transition-colors cursor-pointer ${showNDVI ? 'bg-emerald-500/10 border-emerald-500/20' : 'bg-white/[0.03] border-white/[0.05]'}`}
          ...
          <div className={`p-3 rounded-lg border transition-colors cursor-pointer ${showNDMI ? 'bg-sky-500/10 border-sky-500/20' : 'bg-white/[0.03] border-white/[0.05]'}`}
