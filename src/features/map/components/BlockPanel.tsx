      ...
      <CardContent className="space-y-4">
        ...
        <div className="flex gap-2">
          <Button
            variant="outline"
            size="sm"
            className={`text-[10px] h-7 px-2 ${activeTab === 'all' ? 'bg-emerald-500/20 border-emerald-500/50' : 'bg-transparent border-white/10'}`}
          ...
          <Button
            variant="outline"
            size="sm"
            className={`text-[10px] h-7 px-2 ${activeTab === 'ndvi' ? 'bg-emerald-500/20 border-emerald-500/50' : 'bg-transparent border-white/10'}`}
          ...
          <Button
            variant="outline"
            size="sm"
            className={`text-[10px] h-7 px-2 ${activeTab === 'ndmi' ? 'bg-sky-500/20 border-sky-500/50' : 'bg-transparent border-white/10'}`}
