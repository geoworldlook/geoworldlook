      ...
      <CardContent className="space-y-4">
        <div className="grid grid-cols-3 gap-2">
          <button
            ...
            className={`p-2 rounded-lg border transition-all ${activeTab === 'ndvi' ? 'bg-emerald-500/10 border-emerald-500/50' : 'bg-white/[0.03] border-white/[0.05]'}`}
          >
          ...
          <button
            ...
            className={`p-2 rounded-lg border transition-all ${activeTab === 'ndmi' ? 'bg-sky-500/10 border-sky-500/50' : 'bg-white/[0.03] border-white/[0.05]'}`}
          >
            <p className="text-[8px] text-gray-500 uppercase mb-1 flex items-center gap-1">
