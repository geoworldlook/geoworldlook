    ...
    <Card className="absolute top-4 right-4 w-80 md:w-96 shadow-2xl border-white/[0.1] bg-black/90 backdrop-blur-md animate-in slide-in-from-right duration-300 z-[1000]">
      <CardHeader className="flex flex-row items-center justify-between pb-2 space-y-0">
        <div>
          ...
          <p className="text-xs text-gray-500">{block.area_ha} ha • Precision Monitoring</p>
        </div>
      ...
      <CardContent className="space-y-4">
        ...
        <div className="flex gap-2 mb-2">
          <Button
            variant="outline"
            size="sm"
            className={`text-[10px] h-7 ${activeTab === 'all' ? 'bg-emerald-500/20 border-emerald-500' : 'border-white/10'}`}
          ...
          <Button
            variant="outline"
            size="sm"
            className={`text-[10px] h-7 ${activeTab === 'ndvi' ? 'bg-emerald-500/20 border-emerald-500' : 'border-white/10'}`}
          ...
          <Button
            variant="outline"
            size="sm"
            className={`text-[10px] h-7 ${activeTab === 'ndmi' ? 'bg-blue-500/20 border-blue-500' : 'border-white/10'}`}
