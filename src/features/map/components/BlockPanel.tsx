      ...
      <CardContent className="space-y-4">
        ...
        <div className="flex gap-2 mb-2">
          <Button
            variant="outline"
            size="sm"
            className={`text-[10px] h-7 px-2 ${activeTab === 'both' ? 'bg-white/10' : 'bg-transparent'}`}
          ...
          <Button
            variant="outline"
            size="sm"
            className={`text-[10px] h-7 px-2 ${activeTab === 'ndvi' ? 'bg-emerald-500/10 text-emerald-400' : 'bg-transparent'}`}
          ...
          <Button
            variant="outline"
            size="sm"
            className={`text-[10px] h-7 px-2 ${activeTab === 'ndmi' ? 'bg-sky-500/10 text-sky-400' : 'bg-transparent'}`}
