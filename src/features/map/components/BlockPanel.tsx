          ...
          <>
            ...
            <div className="flex gap-2">
              <Button
                variant="outline"
                size="sm"
                className={`text-[10px] h-7 ${activeTab === 'ndvi' ? 'bg-emerald-500/20 border-emerald-500/50' : ''}`}
              ...
              <Button
                variant="outline"
                size="sm"
                className={`text-[10px] h-7 ${activeTab === 'ndmi' ? 'bg-sky-500/20 border-sky-500/50' : ''}`}
              ...
              <Button
                variant="outline"
                size="sm"
                className={`text-[10px] h-7 ${activeTab === 'both' ? 'bg-white/10 border-white/20' : ''}`}
