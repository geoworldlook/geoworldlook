      ...
      <CardContent className="space-y-4">
        ...
        <div className="flex gap-2">
          <Button
            variant="outline"
            size="sm"
            className={`h-7 text-[10px] ${activeTab === 'ndvi' ? 'bg-emerald-500/20 border-emerald-500/50' : 'bg-transparent'}`}
          ...
          <Button
            variant="outline"
            size="sm"
            className={`h-7 text-[10px] ${activeTab === 'ndmi' ? 'bg-blue-500/20 border-blue-500/50' : 'bg-transparent'}`}
          ...
          <Button
            variant="outline"
            size="sm"
            className={`h-7 text-[10px] ${activeTab === 'both' ? 'bg-white/10 border-white/20' : 'bg-transparent'}`}
