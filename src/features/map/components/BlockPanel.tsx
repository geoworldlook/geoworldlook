      ...
      <CardContent className="space-y-4">
        ...
        <div className="flex gap-2 mb-2">
          <Button
            variant="outline"
            size="sm"
            className={`text-[10px] h-7 px-2 ${activeTab === 'all' ? 'bg-white/10' : ''}`}
          ...
          <Button
            variant="outline"
            size="sm"
            className={`text-[10px] h-7 px-2 ${activeTab === 'ndvi' ? 'bg-emerald-500/10 border-emerald-500/20 text-emerald-400' : ''}`}
          ...
          <Button
            variant="outline"
            size="sm"
            className={`text-[10px] h-7 px-2 ${activeTab === 'ndmi' ? 'bg-sky-500/10 border-sky-500/20 text-sky-400' : ''}`}
        ...
        <div className="flex items-center justify-between text-[10px] text-gray-500 italic">
          ...
          <div className="flex items-center gap-2">
            ...
            {latestData?.cloud_cover.toFixed(1)}% Cloud
          </div>
        </div>
      </CardContent>
    </Card>
