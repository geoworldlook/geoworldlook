          ...
          <>
            ...
            <div className="flex gap-2">
              <Button
                variant="outline"
                size="sm"
                className={`text-[10px] h-7 px-2 ${activeMetric === 'ndvi' ? 'bg-emerald-500/20 border-emerald-500' : ''}`}
              ...
              <Button
                variant="outline"
                size="sm"
                className={`text-[10px] h-7 px-2 ${activeMetric === 'ndmi' ? 'bg-sky-500/20 border-sky-500' : ''}`}
              ...
              <Button
                variant="outline"
                size="sm"
                className={`text-[10px] h-7 px-2 ${activeMetric === 'both' ? 'bg-white/10' : ''}`}
