      ...
      <CardContent className="space-y-4">
        <div className="grid grid-cols-2 gap-4">
          <button
            ...
            className={`p-3 rounded-lg border transition-colors ${showNDVI ? 'bg-emerald-500/10 border-emerald-500/20' : 'bg-white/[0.03] border-white/[0.05] opacity-50'}`}
          >
          ...
          <button
            ...
            className={`p-3 rounded-lg border transition-colors ${showNDMI ? 'bg-sky-500/10 border-sky-500/20' : 'bg-white/[0.03] border-white/[0.05] opacity-50'}`}
          >
            <p className="text-[10px] text-gray-500 uppercase mb-1 flex items-center gap-1">
        ...
        {latestData && (
          <div className="flex items-center gap-4 px-1">
             <div className="flex items-center gap-1.5">
               ...
               <span className="text-xs text-gray-300">{latestData.cloud_cover}% Cloud Cover</span>
             </div>
          </div>
        )}
        ...
        <div className="flex items-center gap-2 text-[10px] text-gray-500 italic">
          ...
          {latestData ? `Last updated: ${latestData.date}` : 'No data available'}
        </div>
      </CardContent>
    </Card>
  );
