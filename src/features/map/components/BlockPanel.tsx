...
export default function BlockPanel({ block, onClose }: BlockPanelProps) {
  ...
  return (
    <Card className="absolute top-4 right-4 w-80 md:w-[400px] shadow-2xl border-white/[0.1] bg-black/90 backdrop-blur-md animate-in slide-in-from-right duration-300 z-[1000]">
