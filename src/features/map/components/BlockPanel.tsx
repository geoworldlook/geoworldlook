      ...
      <CardContent className="space-y-4">
        ...
        <div className="flex gap-2 mb-2">
          <Button
            ...
            className={`text-[10px] h-6 ${activeMetric === 'both' ? 'bg-emerald-500/20 border-emerald-500' : 'bg-transparent'}`}
          > Both </Button>
          <Button
            variant="outline"
            size="sm"
            onClick={() => setActiveMetric('ndvi')}
            className={`text-[10px] h-6 ${activeMetric === 'ndvi' ? 'bg-emerald-500/20 border-emerald-500' : 'bg-transparent'}`}
          > NDVI </Button>
          <Button
            variant="outline"
            size="sm"
            onClick={() => setActiveMetric('ndmi')}
            className={`text-[10px] h-6 ${activeMetric === 'ndmi' ? 'bg-blue-500/20 border-blue-500' : 'bg-transparent'}`}
          > NDMI </Button>
        </div>
