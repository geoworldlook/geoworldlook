      ...
      <CardContent className="space-y-4">
        ...
        <div className="flex gap-2 mb-2">
            <Button
                variant="outline"
                size="sm"
                className={`text-[10px] h-7 px-2 ${activeTab === 'both' ? 'bg-emerald-500/20 border-emerald-500/50 text-emerald-400' : 'bg-transparent border-white/10'}`}
            ...
            <Button
                variant="outline"
                size="sm"
                className={`text-[10px] h-7 px-2 ${activeTab === 'ndvi' ? 'bg-emerald-500/20 border-emerald-500/50 text-emerald-400' : 'bg-transparent border-white/10'}`}
            ...
            <Button
                variant="outline"
                size="sm"
                className={`text-[10px] h-7 px-2 ${activeTab === 'ndmi' ? 'bg-blue-500/20 border-blue-500/50 text-blue-400' : 'bg-transparent border-white/10'}`}
        ...
        <div className="flex items-center justify-between text-[10px] text-gray-500 italic">
          ...
          <div className="flex items-center gap-1">
            <Calendar className="w-3 h-3" /> Updated: {latestData.date}
          </div>
        </div>
      </CardContent>
    </Card>
