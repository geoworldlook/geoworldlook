...
-- 3. Funkcja RPC do pobierania działek jako GeoJSON FeatureCollection
...
-- Nadanie uprawnień do wywoływania funkcji dla ról anonimowych, zalogowanych oraz serwisu
GRANT EXECUTE ON FUNCTION get_vineyard_blocks_geojson() TO anon;
GRANT EXECUTE ON FUNCTION get_vineyard_blocks_geojson() TO authenticated;
GRANT EXECUTE ON FUNCTION get_vineyard_blocks_geojson() TO service_role;
