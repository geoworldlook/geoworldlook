...
if not all([SUPABASE_URL, SUPABASE_KEY, CLIENT_ID, CLIENT_SECRET]):
    print("⚠️ Uwaga: Brak wymaganych zmiennych w .env.local. Skrypt może nie działać w pełni.")
...
# Evalscript z NDVI (B08, B04) oraz NDMI (B08, B11)
SENTINEL_EVALSCRIPT = """
//VERSION=3
function setup() {
  return {
...
def main():
    ...
    # Pobieramy działki z nowej tabeli
