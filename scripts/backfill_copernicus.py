...
def main():
    ...
    # Pobieramy działki z Supabase (geom as geojson string if needed, but PostgREST usually returns it as object if using RPC or View)
    # Since we use direct table select, we might need to handle the geom field properly
