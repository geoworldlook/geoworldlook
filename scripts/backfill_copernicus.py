...
# Evalscript obliczający NDVI i NDMI (B08, B04 dla NDVI; B08, B11 dla NDMI)
VINEYARD_EVALSCRIPT = """
//VERSION=3
function setup() {
  return {
...
def fetch_block_data(token: str, block: dict, days_back: int = 365) -> list:
    # block['geom'] jest oczekiwany jako GeoJSON Polygon
    geom = block['geom']
...
def main():
    ...
    # Aby otrzymać GeoJSON bezpośrednio z PostGIS, moglibyśmy użyć RPC,
    # ale Supabase domyślnie zwraca geometrię w formacie GeoJSON jeśli jest tak skonfigurowane.
