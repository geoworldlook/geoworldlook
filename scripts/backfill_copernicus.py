...
def fetch_block_data(token: str, block: dict, days_back: int = 365) -> list:
    # block['geom'] jest słownikiem GeoJSON (Polygon)
    geometry = block['geom']
...
def main():
    ...
    # Pobieramy działki z Supabase korzystając z RPC dla GeoJSON
    try:
    ...
    if records_to_upsert:
        ...
        try:
            # Dzielimy na paczki po 500 rekordów, aby uniknąć problemów z wielkością requestu
