...
def fetch_block_data(token: str, block: dict, days_back: int = 365) -> list:
    ...
    name = properties.get('name', 'Unknown Block')
...
def main():
    ...
    # Pobieramy geometry z RPC get_vineyard_blocks_geojson, unika to hexów WKB
    try:
    ...
    if not features:
        print("❌ Brak działek w zwróconej FeatureCollection.")
        return
