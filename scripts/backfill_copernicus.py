...
def fetch_block_stats(token: str, block: dict, days_back: int = 365) -> list:
    ...
    print(f"📡 Pobieranie {days_back} dni statystyk dla działki: {block['properties']['name']}...")
...
def main():
    ...
    # Pobieramy bloki winnicy przez RPC (z geometrią GeoJSON)
    try:
    ...
    for block in geojson['features']:
        ...
        for entry in stats:
            ...
            # Pobieramy średnie wartości dla NDVI i NDMI
