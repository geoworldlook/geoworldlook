...
def fetch_block_data(token: str, block: dict, days_back: int = 365) -> list:
    # Używamy geometrii poligonu zamiast bboxa
    # UWAGA: Supabase/PostgREST domyślnie zwraca geometrię jako WKB (hex string),
    # chyba że użyjemy st_asgeojson w zapytaniu lub RPC.
    # Zakładamy że block['geom'] jest już obiektem GeoJSON (z rpc).
...
def main():
    ...
    # Pobieramy bloki winnicy przez RPC aby mieć GeoJSON geometrii
    try:
