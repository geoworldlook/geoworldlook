...
def main():
    print("🚀 Start procesu Backfill (Vineyard Blocks)...")
    
    # Pobieramy działki z Supabase
    # Uwaga: Może być potrzebne rzutowanie geom na GeoJSON jeśli Supabase zwraca WKB
    # Zakładając że biblioteka supabase-py lub PostgREST może wymagać st_asgeojson
