...
def fetch_block_data(token: str, block: dict, days_back: int = 365) -> list:
    # Używamy geometrii z bazy (Polygon)
    geom = block['geom']
...
def main():
    ...
    # Wymaga funkcji RPC lub widoku, jeśli chcemy GeoJSON bezpośrednio,
    # ale tutaj zakładamy, że geom jest dostępny (np. jako GeoJSON string z bazy)
