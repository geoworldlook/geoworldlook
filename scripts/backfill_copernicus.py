...
# Evalscript obliczający NDVI i NDMI dla poligonu
SENTINEL_EVALSCRIPT = """
//VERSION=3
function setup() {
  return {
...
function evaluatePixel(sample) {
  ...
  // NDMI = (B08 - B11) / (B08 + B11) - Water Stress
...
def fetch_block_data(token: str, block: dict, days_back: int = 365) -> list:
    # Pobieramy geometrię poligonu z bazy
    geom = block['geom']
...
def main():
    ...
    # Pobieramy działki z nowej tabeli vineyard_blocks
    ...
    for block in blocks:
        ...
        for entry in stats:
            ...
            # Pobieramy średnie wartości NDVI i NDMI
